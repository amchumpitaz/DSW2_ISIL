...
CREATE TABLE dbo.Tb_Especialidad(
	...
	Descripcion VARCHAR(150) NOT NULL DEFAULT 'Sin Descripción',
	Estado BIT NOT NULL DEFAULT 1
)
GO
...
AS
	...
	BEGIN
		SELECT tu.Cod_Usuario Codigo, tu.Nombres Nombre,tu.Apellidos Apellido,'Usuario' TipoUsuario FROM dbo.Tb_Usuario tu
	...
	BEGIN
		SELECT tp.Cod_Paciente Codigo, tp.Nombres Nombre, tp.Ape_Paterno+' '+tp.Ape_Materno Apellido, 'Paciente' TipoUsuario FROM dbo.Tb_Paciente tp
	...
	BEGIN
		SELECT tod.Cod_Odontologo Codigo, tod.Nombres Nombre, tod.Ape_Paterno+' '+tod.Ape_Materno Apellido, 'Odontologo' TipoUsuario FROM Tb_Odontologo tod
...
EXEC dbo.USP_Insertar_Especialidad
	@Nombre = 'Endodoncia',
	@Descripcion = 'Parte de la odontología que estudia las enfermedades de la pulpa de los dientes y sus técnicas de curación.'
GO
EXEC dbo.USP_Insertar_Especialidad
	@Nombre = 'Ortodoncia',
	@Descripcion = 'Tratamiento que consiste en corregir los defectos y las irregularidades de posición de los dientes.'
GO
EXEC dbo.USP_Insertar_Especialidad
