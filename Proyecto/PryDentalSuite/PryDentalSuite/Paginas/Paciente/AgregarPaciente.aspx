<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarPaciente.aspx.cs" 
    Inherits="PryDentalSuite.Paginas.Paciente.AgregarPaciente"
...
<asp:Content runat="server" ContentPlaceHolderID="cphDinamico">
    ...
    <h2>Ingresa los datos del nuevo Paciente<br /></h2>
    <table class="auto-style14">
        <tr>
            <td class="auto-style15">Codigo:</td>
            <td class="auto-style16">
                <asp:TextBox ID="txtCodigo" runat="server" Width="99px"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style15">
                <asp:Button ID="btnAgregar" runat="server" Text="Agregar" Width="142px" />
            </td>
            <td class="auto-style16">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
