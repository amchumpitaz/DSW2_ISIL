<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarOdontologo.aspx.cs" 
    Inherits="PryDentalSuite.Paginas.Odontologo.EliminarOdontologo" 
...
<asp:Content runat="server" ContentPlaceHolderID="cphDinamico">
    ...
    <h2>Verifica los datos del Odontólogo a Eliminar<br /></h2>
    <table class="auto-style14">
        ...
        <tr>
            ...
            <td class="auto-style16">
                <asp:TextBox ID="txtCOP" runat="server" ReadOnly="True" Width="127px"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
